            ...
            <div class="col-lg-6 col-7">
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  <li class="breadcrumb-item"><a href="#"><i class="fas fa-dollar-sign text-green"></i></a></li>
                  <li class="breadcrumb-item active" aria-current="page">Liste louer</li>
                </ol>
              </nav>
            </div>
        ...
        <div class="col">
          <div class="card bg-default shadow">
            ...
            <div class="card-header bg-transparent border-0">
              <h3 class="text-white mb-0">Table louer</h3>
            </div>
            <!-- Dark table -->
            <div class="table-responsive">
              ...
              <?php include('modal/AjoutLouer_modal.php') ?>
            </div>
          </div>
        </div>
      </div>
