                    ...
                    <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne"
                        ...
                        <form action="../traitement/voiture_post.php" method="POST">
                            ...
                            <div class="mb-2">
                                ...
                                <input type="text" class="form-control" id="#" name="Designation" autocomplete="off" required>
                            </div>
                            <div class="mb-2">
                                <label for="#" class="form-label">Loyer journalier</label>
                                <input type="number" class="form-control" id="#" name="Loyer_Journalier" autocomplete="off" min="0" required>
                            </div>
