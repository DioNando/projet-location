      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="Locataire.php">
            ...
            <div class="col-lg-6 col-7">
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Liste voiture</li>
                </ol>
              </nav>
            </div>
            <div class="col-lg-6 col-5 text-right">
              <a href="voitpdf.php" class="btn btn-sm btn-dark"><i class="fas fa-save text-green"></i></a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col">
          <div class="card bg-default shadow">
            ...
            <div class="card-header bg-transparent border-0">
              <h3 class="text-white mb-0">Table liste voiture</h3>
            </div>
            <!-- Dark table -->
